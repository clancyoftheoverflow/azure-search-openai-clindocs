...
Thought: {agent_scratchpad}"""    
    ...
    CognitiveSearchToolDescription = "useful for searching information in the hospital medical guidelines, such as procedures, checklists, symptoms, etc."
...
class EmployeeInfoTool(CsvLookupTool):
    ...
    def __init__(self, employee_name: str, callbacks: Callbacks = None):
        super().__init__(filename="data/employeeinfo.csv", 
                         key_field="name", 
                         name="Employee", 
                         description="useful for answering questions about information in the hospital medical guidelines",
                         callbacks=callbacks)
